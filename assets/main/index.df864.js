...
System.register("chunks:///_virtual/GameOverUI.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseUI.ts', './ScoreManager.ts', './PropNumberManager.ts', './GameManager.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Label, director, BaseUI, Score, PropNumber, GameManager, GameState;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var RepeatedlyJump = exports('RepeatedlyJump', (_dec = ccclass('RepeatedlyJump'), _dec(_class = (_class2 = /*#__PURE__*/function (_JumpAbility) {
        ...
        function RepeatedlyJump() {
          ...
          _initializerDefineProperty(_this, "jumpCount", _descriptor, _assertThisInitialized(_this));
          _this.hasJumpCount = _this.jumpCount;
          return _this;
        }
        var _proto = RepeatedlyJump.prototype;
        _proto.updateTimer = function updateTimer(dt) {
          if (this.player.getIsGround() || this.hasJumpCount > 0) {
            this.coyoteTimer = this.coyoteTime;
          } else {
            this.coyoteTimer -= dt;
          }
          ...
          if (this.hasJumpCount <= 0 && this.player.getIsGround()) this.hasJumpCount = this.jumpCount;
        };
        return RepeatedlyJump;
      }(JumpAbility), _descriptor = _applyDecoratedDescriptor(_class2.prototype, "jumpCount", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
System.register("chunks:///_virtual/RewindProp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './PropManager.ts', './GameManager.ts', './EventManager.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, resources, Prefab, instantiate, Button, Label, Component, PropManager, GameManager, GameState, EventManager;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
    ...
    execute: function () {
      ...
      var RewindProp = exports('RewindProp', (_dec = ccclass('RewindProp'), _dec(_class = /*#__PURE__*/function (_Component) {
        ...
        _proto.onInit = function onInit(iconPath) {
          var _this2 = this;
          PropManager.instance.addCurrentProp('Rewind');
          ...
          EventManager.instance.on('UPDATE_REWIND_NUMBER', this.onUpdateRewindNumber, this);
          EventManager.instance.on('STOP_REWIND', this.onEnd, this);
        };
    ...
    execute: function () {
      ...
      var ShieldProp = exports('ShieldProp', (_dec = ccclass('ShieldProp'), _dec(_class = /*#__PURE__*/function (_Component) {
        ...
        _proto.onInit = function onInit(iconPath, imagePath) {
          var _this2 = this;
          EventManager.instance.on('UPDATE_SHIELD_NUMBER', this.onUpdateShiledNumber, this);
          EventManager.instance.on('LOSE_SHIELD', this.onEnd, this);
          resources.load(iconPath, Prefab, function (err, prefab) {
            if (err) {
